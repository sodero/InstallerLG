...
sub:            '(' '-' ps ')'                   { $$ = new_native(strdup("-"), LINE, m_sub, $3, NUMBER); };
/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/* comparison.c|h                                                                                                                                                                       */
/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
rexx:           '(' REXX ps opts ')'             { $$ = new_native(strdup("rexx"), LINE, m_rexx, push($3, $4), NUMBER); } |
                ...
                '(' REXX opts ps opts ')'        { $$ = new_native(strdup("rexx"), LINE, m_rexx, push($4, merge($3, $5)), NUMBER); } |
...
message:        '(' MESSAGE ps opts ')'          { $$ = new_native(strdup("message"), LINE, m_message, merge($4, $3), NUMBER); } |
                '(' MESSAGE opts ps')'           { $$ = new_native(strdup("message"), LINE, m_message, merge($3, $4), NUMBER); } |
                '(' MESSAGE opts ps opts ')'     { $$ = new_native(strdup("message"), LINE, m_message, push(merge($3, $5), $4), NUMBER); } |
...
getdiskspace:   '(' GETDISKSPACE p ')'           { $$ = new_native(strdup("getdiskspace"), LINE, m_getdiskspace, push(new_contxt(), $3), NUMBER); } |
                '(' GETDISKSPACE pp ')'          { $$ = new_native(strdup("getdiskspace"), LINE, m_getdiskspace, $3, NUMBER); };
