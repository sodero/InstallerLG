...
askchoice:      '(' ASKCHOICE ')'           { $$ = new_native(strdup("askchoice"), LINE, m_askchoice, NULL, STRING); };
askoptions:     '(' ASKOPTIONS ')'          { $$ = new_native(strdup("askoptions"), LINE, m_askoptions, NULL, NUMBER); };
...
getversion:     '(' GETVERSION p ')'        { $$ = new_native(strdup("getversion"), LINE, m_getversion, push(new_contxt(), $3), STRING); }; 
iconinfo:       '(' ICONINFO p ')'          { $$ = new_native(strdup("iconinfo"), LINE, m_iconinfo, push(new_contxt(), $3), STRING); }; 
...
transcript:     '(' TRANSCRIPT pp ')'       { $$ = new_native(strdup("transcript"), LINE, m_transcript, $3, STRING); }; 
